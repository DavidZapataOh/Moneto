...
import { View, Image, ScrollView, Dimensions, Pressable, LayoutChangeEvent } from "react-native";
...
export default function IntroCarousel() {
  ...
  const handleTextBlockLayout = (slideIdx: number) => (e: LayoutChangeEvent) => {
    ...
    setHeroHeights((prev) => {
      if (Math.abs(prev[slideIdx] - y) < 1) return prev;
      const next = [...prev];
      next[slideIdx] = y;
      return next;
    });
            ...
            {slide.image && (
              <View
                ...
                style={{
                  ...
                  right: 0,
                  width,
                  height: heroHeights[slideIdx] + HERO_EXTEND,
                  overflow: "hidden",
                  zIndex: 1,
                }}
              >
